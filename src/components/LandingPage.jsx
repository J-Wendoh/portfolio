  ...
  return (
    <div className="relative h-screen overflow-hidden bg-black">
      ...
      <div className="flex items-center justify-center h-full">
        <div className="bg-white bg-opacity-20 backdrop-blur-md p-6 sm:p-10 rounded-lg text-center shadow-lg max-w-md">
      ...
      <Link to="/home">
        <button className="absolute bottom-10 left-1/2 transform -translate-x-1/2 px-8 py-3 text-white bg-blue-500 rounded-lg hover:bg-blue-600 transition duration-300 ease-in-out transform hover:scale-105 pulse">
          Get Started
        </button>
      </Link>
    </div>
